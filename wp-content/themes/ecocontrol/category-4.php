                    ...
                    <div class="content">
                        <div class="content-header mb-5">
                            <h3 class="section-title">
                                <?= __('[:ru]Проведенные мероприятия[:ua]Проведені заходи'); ?>
                            </h3>
                            <div class="subtitle">
                                <?= __('[:ru]Здесь вы можете зарегистрироваться на любые события ECOCONTROL[:ua]Тут ви можете зареєструватися на будь-які заходи ECOCONTROL'); ?>
                            </div>
                        </div>
