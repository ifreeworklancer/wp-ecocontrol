            ...
            <div class="row h-100">
                <div class="col-sm-10 col-lg-8 mx-auto d-flex align-items-center justify-content-center">
                    <div class="description">
                        <?= __('[:ru]Мы работаем только на частные пожертвования граждан и не принимаем финансирования от коммерческих или государственных организаций[:ua]Ми працюємо тільки на приватні пожертви громадян і не приймаємо фінансування від комерційних чи державних організацій[:]') ?>
                    </div>
                    <div class="content content-form">
                        <div class="form-header">
                            ...
                            <div class="title">
                                <?= __('[:ru]Мы работаем только благодаря помощи таких людей как вы. Сделайте пожертвование сегодня, чтобы поддержать работу[:ua] Ми працюємо тільки завдяки допомозі таких людей як ви.  Зробіть пожертву сьогодні,щоб підтримати роботу ') ?>
