                ...
                <div class="col-sm-10 col-lg-8 mx-auto d-flex align-items-center justify-content-center">
                    <div class="content content-form">
                        <div class="form-header">
                            ...
                            <div class="title">
                                <?= __('[:ru]Мы работаем только на частные пожертвования граждан и не принимаем финансирования от коммерческих или государственных организаций[:ua] Ми працюємо тільки на приватні пожертви громадян і не приймаємо фінансування від комерційних чи держвавних організацій ') ?>
                            </div>
                        </div>
                        <div class="form-sum">
